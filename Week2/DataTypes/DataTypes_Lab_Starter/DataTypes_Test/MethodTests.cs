...
namespace DataTypes_Test
{
    public class MethodTests
    {
        ...
        //There was a small difference between the calculated
        //result compared to the wanted result - this can be fixed
        //by specifying the precision using the Within feature in NUnit.
        [Test]
